...
aws s3 cp ../aws/cloudfront-template.json s3://rxpowet-bucket-02/cf/cloudfront-template.json
...
--template-url https://rxpowet-bucket-02.s3.amazonaws.com/cf/cloudfront-template.json \
